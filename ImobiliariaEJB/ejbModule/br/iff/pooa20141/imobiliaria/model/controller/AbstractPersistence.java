...
public class AbstractPersistence {
	...
	@PersistenceContext(type = PersistenceContextType.EXTENDED, unitName = "ImobiliariaEJB")
	...
	public void delete(Class<?> classe, int codigo) {
	...
	public <T> T find(Class<T> classe, int codigo) {
